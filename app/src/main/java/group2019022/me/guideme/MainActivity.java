...
public class MainActivity extends AppCompatActivity implements BluetoothProfile.ServiceListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mBluetoothAdapter != null) {
            if(mBluetoothAdapter.isEnabled()) mBluetoothAdapter.getProfileProxy(this, this, BluetoothProfile.A2DP);
        }
    ...
    public void onServiceConnected(int profile, BluetoothProfile bluetoothProfile) {
        ...
        if (profile == BluetoothProfile.A2DP) {
            ...
            BluetoothA2dp btA2dp = (BluetoothA2dp) bluetoothProfile;
            List<BluetoothDevice> a2dpConnectedDevices = btA2dp.getConnectedDevices();
            if (a2dpConnectedDevices.size() != 0) {
                for (BluetoothDevice device : a2dpConnectedDevices) {
                    if (device.getName().contains("HC06")) {
                        connected = true;
                    }
                }
            }
        ...
        if(!connected){
            AlertDialog.Builder bluetoothConnect = new AlertDialog.Builder(this);
            bluetoothConnect.setMessage(R.string.no_bluetoothdevice)
